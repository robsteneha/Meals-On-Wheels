  ...
  <body>
    ...
    <?php
        ...
        function displayFood($categoryname,$categoryimg,$categoryid,$price){
            ...
            <form action=\"sea food.php?action=add&id=$categoryid\" method=\"get\" class=\"cart-items\">
        ...
        {
            $sql="select * FROM orderHistory where f_id=$id and category_id=2 and c_id='$userid' and order_status='P'";
            ...
            else
            {
                ...
                $query1="select * from food where id=$id and category_id=2";
                ...
                if($result1->num_rows>0)
                {
                    ...
                    //echo"price= $price";
                    //echo"title=$title";
                $query2= "INSERT INTO `orderhistory` (`c_id`, `category_id`, `f_id`, `f_title`, `f_price`, `quantity`, `totalAmount`, `order_status`) VALUES ($userid, '2', $id, '$title', '$price', '1', NULL, 'P')";
        ...
        if(isset($_GET['add10']))
        {
            addToCart(10,$userid,$con);
        }
        else if(isset($_GET['add11']))
        {
            addToCart(11,$userid,$con);
        }
        elseif(isset($_GET['add12']))
        {
            addToCart(12,$userid,$con);
        }
        elseif(isset($_GET['add13']))
        {
            addToCart(13,$userid,$con);
        }
        elseif(isset($_GET['add14']))
        {
            addToCart(14,$userid,$con);
        }
